...
const MainPage = () => {
  ...
  return (
    <div className=" flex flex-col justify-start items-start">
      <div
        className="h-[700px] w-full cover md:h-[700px] bg-cover bg-gradient-to-r from-gray-700 to-gray-500 relative"
        style={{
          backgroundImage:
            "linear-gradient(to bottom, rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6)),url(https://assets.nflxext.com/ffe/siteui/vlv3/a73c4363-1dcd-4719-b3b1-3725418fd91d/fe1147dd-78be-44aa-a0e5-2d2994305a13/IN-en-20231016-popsignuptwoweeks-perspective_alpha_website_large.jpg)",
        }}
      >
        <div className="w-full flex justify-center  items-center gap-[900px] p-4">
          <Header />
          <button
            className="h-8 w-20 text-center text-sm text-white font-medium bg-red-600 rounded-md"
        ...
        <div className="flex justify-center items-center h-full">
          <div className="mb-[170px]">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-2 mt-4">
              ...
              />
              <button
                className="w-full md:w-1/4 h-12 text-center text-white bg-red-600 rounded-md text-lg md:text-xl font-bold"
                onClick={navigateSignIn}
              >
                Get Started
              </button>
